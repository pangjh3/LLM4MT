...
refile="/apdcephfs/share_733425/vinnylywang/jianhuipang/fairseq/wmt23models2/results/de2en.10000000.hyp.out"

srclines=open(srcfile, 'r').readlines()
tgtlines=open(tgtfile, 'r').readlines()

alignfile="./wmt23test.align2.out"
# alignfile="./wmt23test.align3sdot01.out"
...
# testdatafile="./test.data3sdot07.out"
# testdatafile="./test.data3sdot01.out"
...
swfreq={}
ii=0
for refdata, refalign, mtdata, mtalign in zip(refdatalines, refalignlines, llmsdatalines, llmsalignlines):
    ii+=1
    if mtdata == "":
        continue
