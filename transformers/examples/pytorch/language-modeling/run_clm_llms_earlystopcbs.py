...
def main():
    ...
    if training_args.do_train:
        ...
        # xxx: stream dataset to iterdataset
    ...
    if training_args.do_eval:
        ...
        metric = evaluate.load("/apdcephfs/share_733425/vinnylywang/jianhuipang/evaluate/metrics/accuracy/accuracy.py")
    ...
    if model_args.early_stopping_patience > 0:
        logger.info("xxx: set early stop.")
