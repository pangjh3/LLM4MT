...
def main():
    ...
    # xxx 2023-12, add new tokens
    num_added_toks = tokenizer.add_special_tokens(
        {
            "additional_special_tokens": [DEFAULT_PJH_TOKEN],
        }
    )
    ...
    newtokenid=tokenizer.convert_tokens_to_ids(DEFAULT_PJH_TOKEN)
    ...
    replace_llama_forward(tokenizer.convert_tokens_to_ids(DEFAULT_PJH_TOKEN), tokenizer.pad_token)
